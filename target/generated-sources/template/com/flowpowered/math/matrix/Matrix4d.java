...
public class Matrix4d implements Matrixd, Serializable, Cloneable {
    ...
    public int hashCode() {
        if (!hashed) {
            int result = (m00 != +0.0f ? Double.hashCode(m00) : 0);
            result = 31 * result + (m01 != +0.0f ? Double.hashCode(m01) : 0);
            result = 31 * result + (m02 != +0.0f ? Double.hashCode(m02) : 0);
            result = 31 * result + (m03 != +0.0f ? Double.hashCode(m03) : 0);
            result = 31 * result + (m10 != +0.0f ? Double.hashCode(m10) : 0);
            result = 31 * result + (m11 != +0.0f ? Double.hashCode(m11) : 0);
            result = 31 * result + (m12 != +0.0f ? Double.hashCode(m12) : 0);
            result = 31 * result + (m13 != +0.0f ? Double.hashCode(m13) : 0);
            result = 31 * result + (m20 != +0.0f ? Double.hashCode(m20) : 0);
            result = 31 * result + (m21 != +0.0f ? Double.hashCode(m21) : 0);
            result = 31 * result + (m22 != +0.0f ? Double.hashCode(m22) : 0);
            result = 31 * result + (m23 != +0.0f ? Double.hashCode(m23) : 0);
            result = 31 * result + (m30 != +0.0f ? Double.hashCode(m30) : 0);
            result = 31 * result + (m31 != +0.0f ? Double.hashCode(m31) : 0);
            result = 31 * result + (m32 != +0.0f ? Double.hashCode(m32) : 0);
            hashCode = 31 * result + (m33 != +0.0f ? Double.hashCode(m33) : 0);
            hashed = true;
        }
        return hashCode;
    }
